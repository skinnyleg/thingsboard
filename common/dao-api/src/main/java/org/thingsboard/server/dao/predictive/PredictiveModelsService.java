...
public interface PredictiveModelsService {
    ...
    PredictiveModel savePredictiveModel(PredictiveModel predictiveModel);

    void deletePredictiveModel(TenantId tenantId, PredictiveModelId predictiveModelId);
