...
def train_and_save_model(
    ...
    **kwargs,
    ...
    # print kwargs
    print(f"[TRAIN_AND_SAVE] Additional parameters: {kwargs}", flush=True)
    ...
    if model_type == "AnomalyPredictor":
        ...
        # stop if failures data is empty
        if failures_df.empty:
            print(
                f"[TRAIN_AND_SAVE] No failure data found for device_id={device_id}. Aborting training.",
                flush=True,
            )
            return {
                "status": "failed",
