...
class CatBoostAdapter(BaseAlgorithm):
    """Adapter for CatBoost algorithm"""
    ...
    def train(self, X: pd.DataFrame, y: Optional[pd.Series] = None) -> TrainingMetrics:
        ...
        if y is None:
            raise ValueError("CatBoost requires target variable y")
    ...
    def predict(self, X: pd.DataFrame) -> PredictionOutput:
        ...
        return PredictionOutput(
            ...
            metadata={"algorithm": "catboost", "n_samples": len(X)},
        )
