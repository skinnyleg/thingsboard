...
class XGBoostAdapter(BaseAlgorithm):
    """Adapter for XGBoost algorithm"""
    ...
    def train(self, X: pd.DataFrame, y: Optional[pd.Series] = None) -> TrainingMetrics:
        """Train XGBoost model"""
        if y is None:
            raise ValueError("XGBoost requires target variable y")
    ...
    def predict(self, X: pd.DataFrame) -> PredictionOutput:
        ...
        return PredictionOutput(
            ...
            metadata={"algorithm": "xgboost", "n_samples": len(X)},
        )
