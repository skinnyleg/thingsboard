...
do
        ...
        sleep 2
        mosquitto_pub -d -q 1 -h thingsboard -p 1883 -t v1/devices/me/telemetry -u "Xf3yHz6EVsiaRMnfYvJn" -m "{pressure:$VALUE}" > /dev/null
done