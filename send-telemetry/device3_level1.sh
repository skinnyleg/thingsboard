...
do
        ...
        sleep 2
        mosquitto_pub -d -q 1 -h thingsboard -p 1883 -t v1/devices/me/telemetry -u "OKV950bum6RVI7x3Do6x" -m "{level:$VALUE}" > /dev/null
done