...
public interface AnomalyDetectorDao extends Dao<Detector> {
    ...
    Detector saveAndFlush(TenantId tenantId, Detector detector);

    // Detector activateDetector(TenantId tenantId, DetectorId detectorId);
}
